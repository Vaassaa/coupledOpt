...
# --- HPC SAFETY: prevent thread oversubscription ---
...
# Mapping of workers to cluster cores
N_CORES = int(os.environ.get("PBS_NCPUS", 64))
...
if __name__ == '__main__':
    ...
    # Define intial starting population from stage 1
    init = np.tile(result_stage1.x, (8 * len(bounds), 1))
